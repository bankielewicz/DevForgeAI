...
ls -la .ai_docs/Epics/EPIC-*.epic.md
```
...
3. **Epic File Missing**
   ...
   - **Debug:** Check `.ai_docs/Epics/` directory for epic file
...
stat .ai_docs/Epics/EPIC-*.epic.md
...
1. **Epic File Path Incorrect**
   - **Expected Path:** `.ai_docs/Epics/EPIC-XXX-{slug}.epic.md`
...
2. **File Permissions Issue**
   ...
   - **Fix:** `chmod 644 .ai_docs/Epics/EPIC-*.epic.md`
   - **Verify:** `cat .ai_docs/Epics/EPIC-*.epic.md` works
...
grep -E "(features:|complexity:|risks:)" .ai_docs/Epics/EPIC-*.epic.md
...
2. **CLI Can't Parse Epic File**
   ...
   - **Verify:** `cat .ai_docs/Epics/EPIC-*.epic.md | head -50` (check frontmatter)
...
2. **CLI Not Extracting Metadata**
   ...
   - **Fix:** Verify CLI implementation reads `.ai_docs/Epics/{EPIC-ID}-*.epic.md`
...
ls .ai_docs/Epics/ | grep -v "^EPIC-[0-9]{3}"
```
