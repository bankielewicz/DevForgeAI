#!/bin/bash
# Test: AC#5 - insights.md meets lean orchestration targets
# Story: STORY-461
# Generated: 2026-02-21
# Expected state: FAIL against pre-refactoring file (276 lines, no Lean section)

PASS=0
FAIL=0
TARGET="/mnt/c/Projects/DevForgeAI2/src/claude/commands/insights.md"
...
echo "=== AC#5: insights.md Lean Orchestration Targets ==="

# --- File exists ---
[[ -f "$TARGET" ]]
run_test "insights.md file exists" $?
