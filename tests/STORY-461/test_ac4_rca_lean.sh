#!/bin/bash
# Test: AC#4 - rca.md meets lean orchestration targets
# Story: STORY-461
# Generated: 2026-02-21
# Expected state: FAIL against pre-refactoring file (448 lines, no Lean section)

PASS=0
FAIL=0
TARGET="/mnt/c/Projects/DevForgeAI2/src/claude/commands/rca.md"
...
echo "=== AC#4: rca.md Lean Orchestration Targets ==="

# --- File exists ---
[[ -f "$TARGET" ]]
run_test "rca.md file exists" $?

# --- Line count <=120 ---
LINE_COUNT=$(wc -l < "$TARGET")
echo "  INFO: Line count = $LINE_COUNT (target <=120)"
[[ "$LINE_COUNT" -le 120 ]]
run_test "Line count is <=120 (current: $LINE_COUNT)" $?
