#!/bin/bash
# Test: AC#3 - ideate.md reduced to lean orchestration pattern
# Story: STORY-460
...
TARGET_FILE="${PROJECT_ROOT}/src/claude/commands/ideate.md"
...
echo "=============================================="
echo "  AC#3: ideate.md Lean Orchestration"
...
run_test "Line count <= 90 (actual: ${LINE_COUNT})" "$test_result"
