#!/bin/bash
# STORY-174 AC#2: dev.md Command Has execution-mode Frontmatter
#
...
TEST_NAME="AC#2: dev.md execution-mode frontmatter"
COMMAND_FILE="/mnt/c/Projects/DevForgeAI2/.claude/commands/dev.md"
...
if echo "${FRONTMATTER}" | grep -q "^execution-mode: immediate$"; then
    echo "PASS: dev.md contains 'execution-mode: immediate' in frontmatter"
    exit 0
else
    echo "FAIL: dev.md does NOT contain 'execution-mode: immediate' in frontmatter"
    echo ""
