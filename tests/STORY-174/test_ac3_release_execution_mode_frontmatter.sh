#!/bin/bash
# STORY-174 AC#3: release.md Command Has execution-mode Frontmatter
#
...
TEST_NAME="AC#3: release.md execution-mode frontmatter"
COMMAND_FILE="/mnt/c/Projects/DevForgeAI2/.claude/commands/release.md"
...
if echo "${FRONTMATTER}" | grep -q "^execution-mode: immediate$"; then
    echo "PASS: release.md contains 'execution-mode: immediate' in frontmatter"
    exit 0
else
    echo "FAIL: release.md does NOT contain 'execution-mode: immediate' in frontmatter"
    echo ""
