...
# Lazy import - will be set by fixture
...
def setup_imports():
    """Setup imports at runtime after conftest.py has configured sys.path."""
    global PlatformDetector, PlatformInfo
    from installer.platform_detector import PlatformDetector as PD, PlatformInfo as PI
    PlatformDetector = PD
    PlatformInfo = PI
