...
Note: Visualization (token-savings-chart.png) requires matplotlib library.
If matplotlib is not available in the test environment, no chart will be generated.
This is a non-critical, optional enhancement for the report.
