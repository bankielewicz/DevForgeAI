...
**Description:** Integrate guidance into designing-systems, devforgeai-ui-generator, devforgeai-orchestration

**Deliverables:**
- Update `src/claude/skills/designing-systems/SKILL.md`: Phase 1 (Context Discovery)
