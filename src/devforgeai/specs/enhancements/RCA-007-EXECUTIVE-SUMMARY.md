...
> "How do we enhance story creation to create stories per epic document? If I provide `/create-story epic-001`, I would like Claude to create every story file related to epic-001 in sequence with the next numbering based on the .ai_docs/stories/ numbering sequence."
