...
model: opus  # Or 'inherit' to use parent conversation model
---
...
- **Automatic**: When designing-systems skill creates context files
...
model: opus  # Fast validation, simple logic
```
...
model: opus  # Or 'haiku' for simple tasks, 'inherit' for adaptive
---
...
- [ ] Subagents invoked from designing-systems skill
...
Skill:
  ...
  examples: Skill(command="designing-systems")
