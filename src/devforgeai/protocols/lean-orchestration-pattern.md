...
**Why This Fails:**
- Claude interprets documented steps as instructions to perform
- This is Claude's instruction-following behavior - it follows what it reads
- Skill invocation comes AFTER manual work, not BEFORE
- Results in duplicate work or skill bypass entirely
- **Evidence:** RCA-037 + RCA-038 documented this pattern's failure
