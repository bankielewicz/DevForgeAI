...
| 2 | 2026-09-16 | claude-code | Reviewed against PRD-001 v2: reuse confirmed, no architectural change. Policy resolution: interview.max_calls=8 (default); architecture.mandated_platforms=none (default); quality.required_categories=floor only (default) | frontmatter |
FIXTURE_EOF
