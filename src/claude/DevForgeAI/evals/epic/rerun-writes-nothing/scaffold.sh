...
set -euo pipefail
mkdir -p docs/specs/adr docs/specs/arch docs/specs/epic docs/specs/policy docs/specs/prd
...
The member self-service web app for Harbour Yoga Studio, defined against PRD-001 version 2 (approved).
...
| Version | Date | Author | Change | Items affected |
|---|---|---|---|---|
| 1 | 2026-09-16 | claude-code | Initial draft for PRD-001 v2; DEC-07 resolved by POL-001#SET-01 (mandated platform). Policy resolution: interview.max_calls=8 (default); architecture.mandated_platforms=Harbour Group File Store for file storage (POL-001#SET-01); quality.required_categories=floor only (default) | all |
...
FIXTURE_EOF
cat > docs/specs/epic/EPIC-001.md <<'FIXTURE_EOF'
---
id: EPIC-001
type: epic
title: "Members manage their own class bookings"
status: approved
version: 1
created: 2026-09-19
updated: 2026-09-19
...
upstream:
  ...
  - {id: PRD-001, item: FR-003, relation: refines, version: 2, hash: null}
  - {id: PRD-001, item: FR-004, relation: refines, version: 2, hash: null}
  - {id: PRD-001, item: FR-012, relation: refines, version: 2, hash: null}
  - {id: PRD-001, item: NFR-001, relation: refines, version: 2, hash: null, note: "partial: booking pages"}
  - {id: ARCH-001, relation: informed_by, version: 3, hash: null}
supersedes: []
superseded_by: null
blocked_by: []
# --- epic-specific ---
...
# EPIC-001 — Members manage their own class bookings

## 1. Goal

Members book and manage their class places online. SEED-MARKER-epic1

## 2. Business value

Raises the share of bookings made online (PRD-001#SM-01).
...
done_when:
  - id: DW-01
    status: active
    criterion: "A member books and cancels a class place online without staff help"
    evidence_method: "End-to-end test on the staging site"
```

## 5. Dependencies and risks

Relies on ARCH-001#DEC-02.
...
|---|---|---|---|
| 1 | 2026-09-19 | claude-code | Initial draft from PRD-001 v2 and ARCH-001 v3 |
FIXTURE_EOF
