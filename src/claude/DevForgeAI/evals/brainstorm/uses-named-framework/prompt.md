---
description: "VER-04 (STORY-001#AC-04): asked for diverge-converge, the skill names the framework and writes only the brainstorm schema's collections and fields."
tags: [brainstorm, ver-04]
max_turns: 30
timeout_seconds: 900
allowed_tools: [Read, Glob, Grep, Skill]
---
Brainstorm how to reduce onboarding drop-off in our mobile banking app, using the diverge-converge framework.
...
Proceed without asking me questions, and write the brainstorm document.
