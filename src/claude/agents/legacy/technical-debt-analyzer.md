...
proactive_triggers:
  ...
  - "when spec-driven-lifecycle skill invokes in Phase 5 (Deferred Work Tracking)"
---
...
- When technical-debt-register.md updates
- By spec-driven-lifecycle skill (Phase 5: Deferred Work Tracking)
...
1. Check if `devforgeai/technical-debt-register.md` exists
   - If not found: Read template from `.claude/skills/spec-driven-lifecycle/assets/templates/technical-debt-register-template.md`, write to create register
...
**Invoked by:**
- spec-driven-lifecycle skill (Phase 5: Deferred Work Tracking during sprint planning)
- `/create-sprint` command (before sprint planning)
- Manual invocation for quarterly debt reviews

**Returns to:**
- spec-driven-lifecycle skill: debt count, trends, critical issues, recommendations
