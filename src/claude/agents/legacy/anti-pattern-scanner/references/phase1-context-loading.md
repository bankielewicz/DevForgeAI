...
IF NOT file_exists(file_path):
  RETURN {
    ...
    "blocks_qa": true,
    "remediation": "Run /create-system-architecture to generate architectural context files"
  }
```
...
- God object thresholds (>20 methods, >300 lines) <!-- Threshold unified to >20 per REC-369-001 to match Treelint mode -->
