...
Agents created from this template must respect the following line count limits (Source: tech-stack.md, lines 385-388; devforgeai/specs/context/source-tree/governance.json):
...
- **Source**: devforgeai/specs/context/source-tree/governance.json (agent file constraints, progressive disclosure)
