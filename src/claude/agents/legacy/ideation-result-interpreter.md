...
Count existing context files:
  ...
  IF 0 files: greenfield → next action: /create-system-architecture
...
║   - {decision_2}                                          ║
╠═══════════════════════════════════════════════════════════╣
║ Next: 1./create-system-architecture                       ║
║       2./create-missing-stories  3./dev                   ║
╚═══════════════════════════════════════════════════════════╝
```
...
|--------|-----------|-----------|
| SUCCESS (Tier 1-2, low complexity) | /create-system-architecture (minimal) | /create-missing-stories |
| SUCCESS (Tier 3, moderate complexity) | /create-system-architecture (standard) | /create-sprint |
| SUCCESS (Tier 4, high complexity) | /create-system-architecture (comprehensive) | /dev |
| WARNING | /ideate again OR /create-system-architecture with gaps | /create-missing-stories OR /ideate |
...
```json
{
  ...
  "display": {
    ...
    "next_steps": ["/create-system-architecture", "/create-sprint", "/dev"]
  },
...
- **Commands**: `.claude/commands/` (next steps guidance)
