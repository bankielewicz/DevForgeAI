...
- **example_finding:** CLAUDE.md says "initializes the connection pool via a lazy singleton" but anti-patterns.md Category 1 forbids "lazy singleton initialization for shared resources"
...
- **category:** CC
- **severity:** MEDIUM
- **layer_a:** `devforgeai/specs/context/source-tree/`
- **layer_b:** `CLAUDE.md`
- **description:** File paths and component locations consistency
- **method:** Extract file paths mentioned in CLAUDE.md using Grep for path-like patterns (containing `/`). Verify each path exists in source-tree/ directory listing. If a path is referenced in CLAUDE.md but absent from source-tree/, flag.
- **example_finding:** CLAUDE.md references "src/hook/" but source-tree/ defines the path as "native/hook/"
...
- **example_finding:** CLAUDE.md mentions "PostgreSQL 14" but dependencies.md pins "PostgreSQL 16.2"
...
- **method:** Check: dependencies.md packages vs tech-stack.md approved technologies; source-tree/ paths vs coding-standards.md naming conventions; architecture-constraints.md layers vs source-tree/ directory structure. Flag any mismatches.
...
- **example_finding:** tech-stack.md declares "Linux x64, Python 3.12+" but system prompt has no platform constraint section
...
- **category:** CMP
- **severity:** MEDIUM
- **layer_a:** `devforgeai/specs/context/tech-stack.md` + `devforgeai/specs/context/source-tree/`
- **layer_b:** `CLAUDE.md`
...
| CC-04 | CC | MEDIUM | source-tree/ | CLAUDE.md |
...
| CMP-02 | CMP | MEDIUM | tech-stack.md + source-tree/ | CLAUDE.md |
