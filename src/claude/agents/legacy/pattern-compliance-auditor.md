...
**Automatic:**
- spec-driven-lifecycle skill during `/audit-budget` command execution (Phase 2: Budget scanning)
- spec-driven-lifecycle skill during `/audit-deferrals` command execution (Phase 5: Debt analysis)
