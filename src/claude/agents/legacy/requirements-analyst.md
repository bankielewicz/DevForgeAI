...
**Automatic:**
- spec-driven-lifecycle skill during story creation
...
**Context:** During spec-driven-lifecycle skill sprint planning, an epic needs to be decomposed into implementable stories.
...
**Works with:**
- spec-driven-lifecycle: Generates stories during sprint planning
...
**Invoked by:**
- spec-driven-lifecycle (story creation phase)
