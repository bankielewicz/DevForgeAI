...
**DO:**
- Use source-tree.md to validate documentation output locations (docs/*, .claude/memory/*)
...
**DO NOT:**
- Create documentation in locations outside source-tree.md patterns
...
- Write access only to documented output locations per source-tree.md
