---
description: Orchestrator for the devforgeai-research skill that captures and persists research findings
argument-hint: "[topic] | [--resume ID] | [--search query] | [--list ] [--category type]"
model: opus
---
