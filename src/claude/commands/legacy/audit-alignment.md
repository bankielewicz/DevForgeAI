...
argument-hint: "[--layer=all|claudemd|prompt|context|rules|adrs] [--fix] [--output=console|file]"
model: opus
...
IF $FIX == true:
  ...
  FOR finding IN findings:
    ...
    ELIF finding.layer_b matches "context files":
      ...
      Display: "  → Run: /create-system-architecture to update via proper workflow"
...
IF 6 context files not all present:
  ...
  Display: "   Run /create-system-architecture to generate"
  HALT
...
**Invoked by:** Framework maintainers, after /create-system-architecture, after ADR acceptance
