...
Generate comprehensive failing test suite (TDD Red phase) to validate TodoWrite integration in devforgeai-ideation workflow files:
...
2. `.claude/skills/devforgeai-ideation/references/complexity-assessment-workflow.md`
3. `.claude/skills/devforgeai-ideation/references/feasibility-analysis-workflow.md`
...
- Workflow files: `.claude/skills/devforgeai-ideation/references/`
