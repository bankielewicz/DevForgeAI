...
### Files to be Fixed
1. `.claude/skills/devforgeai-ideation/references/artifact-generation.md` (lines 469, 598, 599)
2. `.claude/skills/devforgeai-ideation/references/error-handling.md` (lines 184, 868)
