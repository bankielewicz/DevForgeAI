...
{Clear, measurable business objective}
...
{Summary from Phase 2.1 - link to detailed requirements spec}
...
### Integration Points
1. {Integration 1}: {Purpose, protocol}
2. {Integration 2}: {Purpose, protocol}
...
**Complexity Tier:** {1-4} ({Simple|Moderate|Complex|Enterprise})

**Recommended Architecture:**
- Pattern: {architecture pattern from Phase 3}
- Layers: {layer structure}
- Database: {database strategy}
- Deployment: {deployment approach}

**Technology Recommendations:**
{From complexity-assessment-matrix.md for this tier}

## Risks & Mitigations

| Risk | Severity | Mitigation |
|------|----------|------------|
| {Risk 1} | CRITICAL | {Strategy} |
| {Risk 2} | HIGH | {Strategy} |
...
**Dependents:**
- {Epic/Feature that depends on this}

## Next Steps

1. **Architecture Phase:** Create 6 context files via `/create-context`
2. **Sprint Planning:** Create Sprint 1 via `/create-sprint`
3. **Story Creation:** Break features into stories via `/create-story`
```
