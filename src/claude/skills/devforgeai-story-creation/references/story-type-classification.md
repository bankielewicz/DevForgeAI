...
- **Phase 01.6 Type Detection**: `.claude/skills/implementing-stories/references/preflight/_index.md`
- **Phase Skip Logic**: `.claude/skills/implementing-stories/references/integration-testing.md`
