...
- **Phase 01.6 Type Detection**: `.claude/skills/spec-driven-dev/references/preflight/_index.md`
- **Phase Skip Logic**: `.claude/skills/spec-driven-dev/references/integration-testing.md`
