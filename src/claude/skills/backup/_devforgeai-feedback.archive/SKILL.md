...
description: >
  ARCHIVED — Absorbed into spec-driven-feedback per ADR-040 (2026-03-18).
  Do NOT invoke this skill. Use spec-driven-feedback instead.
  All reference files, templates, and HOOK-SYSTEM.md have been migrated to spec-driven-feedback.
version: 2.0
