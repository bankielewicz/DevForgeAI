...
> **HALT - DO NOT USE** This skill has been superseded by `spec-driven-research`.
> Archived: 2026-03-18. Use `src/claude/skills/spec-driven-research/` instead.

# DevForgeAI Research Skill [ARCHIVED]
