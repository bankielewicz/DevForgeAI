...
**Treelint Integration:** This subagent is Treelint-enabled for AST-aware test-to-source mapping (40-80% token reduction). Treelint availability is detected automatically; falls back to Grep-based file matching when unavailable.
...
4. **Code Smells (MEDIUM):**
   - God objects (>20 methods, >300 lines) <!-- Threshold unified to >20 per REC-369-001 -->
