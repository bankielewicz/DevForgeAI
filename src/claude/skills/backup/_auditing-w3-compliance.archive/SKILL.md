---
name: auditing-w3-compliance
description: W3 compliance scanning - detects auto-skill chaining violations
---
...
# Check if each has user approval pattern (user consent gate before Skill)
