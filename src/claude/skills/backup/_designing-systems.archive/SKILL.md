...
**Invoked by:** `/create-context`, `/create-epic`, spec-driven-ideation skill, spec-driven-dev skill (if context files missing)
...
**Schema:** `spec-driven-ideation/assets/templates/requirements-schema.yaml`
...
**From:** spec-driven-ideation (YAML-structured requirements -> architecture Phase 11)
**To:** devforgeai-orchestration (story planning), spec-driven-dev (implementation)
