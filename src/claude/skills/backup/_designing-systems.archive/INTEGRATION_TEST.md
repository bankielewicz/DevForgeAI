...
**SKILL.md references:**
- ✅ `.claude/skills/designing-systems/assets/context-templates/tech-stack.md`
- ✅ `.claude/skills/designing-systems/assets/context-templates/source-tree.md`
- ✅ `.claude/skills/designing-systems/assets/context-templates/dependencies.md`
- ✅ `.claude/skills/designing-systems/assets/context-templates/coding-standards.md`
- ✅ `.claude/skills/designing-systems/assets/context-templates/architecture-constraints.md`
- ✅ `.claude/skills/designing-systems/assets/context-templates/anti-patterns.md`
- ✅ `.claude/skills/designing-systems/references/adr-template.md`
- ✅ `.claude/skills/designing-systems/references/ambiguity-detection-guide.md`
...
1. ✅ **Create all 4 template files in designing-systems skill assets**
...
1. **Initialize context files:**
   ```bash
   .claude/skills/designing-systems/scripts/init_context.sh
   ```

2. **Activate designing-systems skill in Claude Code:**
