...
|-------|-------|----------|
| `opus` | Claude Opus 4.6 | Complex reasoning, specialized tasks |
| `sonnet` | Claude Sonnet 4.6 | Daily coding (default) |
...
**[user-input-guidance.md](../discovering-requirements/references/user-input-guidance.md)** (Framework-Internal Reference)
...
- v2.0 (2025-12-20): Major update with December 2025 features - background tasks, checkpoints, sessions, Opus 4.6, model switching, remote MCP, plugins enhancement
