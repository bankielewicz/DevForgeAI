...
**Treelint Integration:** This subagent is Treelint-enabled for AST-aware semantic code search (40-80% token reduction). Treelint availability is detected automatically with fallback to Grep-based scanning when unavailable.
