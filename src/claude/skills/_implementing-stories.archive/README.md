...
The `implementing-stories` skill transforms user stories and feature specifications into tested, production-ready code that complies with architectural decisions documented in context files.

### Key Capabilities

1. **Context-Driven Development**
   - Validates tech-stack.md, source-tree.md, dependencies.md before coding
   - Auto-invokes spec-driven-architecture skill if context files missing
...
The skill executes 12 phases (01-10 plus 04.5 and 05.5):
...
### Phase 04.5: AC Verification (Post-Refactor)
- Verify acceptance criteria compliance
- Generate compliance report
- Identify gaps or partial implementations
...
- Prepare for deferral challenge

### Phase 06: Deferral Challenge
- Review any deferred Definition of Done items
- Validate deferral justifications
- User approval for deferrals

### Phase 07: DoD Update
- Update Implementation Notes in story file
- Document completed DoD items
...
### devforgeai-qa
**When invoked:** Implementation complete, ready for QA validation

**Handoff:** Tests passing, coverage met, no anti-patterns, build succeeds

**Modes:** Light (during development) or Deep (comprehensive validation)

### devforgeai-release
**When invoked:** QA approved, ready for release to target environments

**Handoff:** All validations passed, documentation updated, commits created, smoke tests pass
...
- **spec-driven-architecture** - Creates context files this skill enforces
