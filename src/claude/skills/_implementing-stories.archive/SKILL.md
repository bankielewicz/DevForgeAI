...
description: >
  ARCHIVED — Absorbed into spec-driven-dev per ADR-039 (2026-03-18).
  Do NOT invoke this skill. Use spec-driven-dev instead.
  Original: Implements user stories through Test-Driven Development (Red-Green-Refactor) while enforcing architectural constraints from six context files.
allowed-tools:
  - Read
  - Write
  - Edit
...
**Integration:**
- **From:** devforgeai-story-creation (story+AC), spec-driven-architecture (context files)
- **To:** devforgeai-qa (validation), devforgeai-release (deployment)
- **Auto-invokes:** spec-driven-architecture (if missing), devforgeai-qa (light mode)
