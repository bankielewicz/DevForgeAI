...
**Schema file:** `.claude/skills/designing-systems/references/skill-output-schemas.yaml`
...
The designing-systems skill executes 8-phase epic creation:
...
**Condition:** designing-systems skill returns error
**Action:**
```
...
If error persists, check:
  1. Skill exists: .claude/skills/designing-systems/SKILL.md
  2. Reference files exist: .claude/skills/designing-systems/references/
...
**Invokes:** designing-systems skill (epic creation mode)
