...
**Purpose:** Document how designing-systems skill integrates user-input-guidance.md with conditional loading logic for greenfield vs brownfield project contexts.
...
def phase_1_context_discovery():
    ...
    if context_count == 6:
        ...
        guidance_content = Read(file_path=".claude/skills/designing-systems/references/user-input-guidance.md")
...
- If loading guidance:
  - Execute: `Read(file_path=".claude/skills/designing-systems/references/user-input-guidance.md")`
...
- Location: `src/.claude/skills/designing-systems/references/user-input-guidance.md`
- Deployment: Copy from master using:
  ```bash
  cp src/.claude/skills/discovering-requirements/references/user-input-guidance.md \
     src/.claude/skills/designing-systems/references/user-input-guidance.md
  ```

**Operational Folder:**
- Also copied to: `.claude/skills/designing-systems/references/user-input-guidance.md`
...
sha256sum src/.claude/skills/designing-systems/references/user-input-guidance.md \
          .claude/skills/designing-systems/references/user-input-guidance.md
...
1. Update: `src/.claude/skills/discovering-requirements/references/user-input-guidance.md`
...
- [ ] **Operational:** user-input-guidance.md synced to .claude/skills/designing-systems/
