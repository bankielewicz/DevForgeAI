...
| Document | Path |
|----------|------|
| Phase 4.5 Definition | `.claude/skills/implementing-stories/phases/phase-04.5-ac-verification.md` |
| Phase 5.5 Definition | `.claude/skills/implementing-stories/phases/phase-05.5-ac-verification.md` |
| AC Compliance Verifier Subagent | `.claude/agents/ac-compliance-verifier.md` |
| SKILL.md (AC Verification sections) | `.claude/skills/implementing-stories/SKILL.md` (lines 520-543, 551-553) |
