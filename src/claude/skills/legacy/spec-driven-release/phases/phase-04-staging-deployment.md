...
Build the registry-protected Phase 04 handoff for `deployment-engineer`. This
...
: > tmp/${STORY_ID}/release-phase04-deployment-engineer-handoff-changed-files.txt
...
HANDOFF_OUTPUT_DEPLOYMENT_ENGINEER=$(devforgeai-validate build-subagent-handoff ${STORY_ID} \
    ...
    --changed-files-file=tmp/${STORY_ID}/release-phase04-deployment-engineer-handoff-changed-files.txt \
    --project-root=. 2>&1)
...
- `tmp/${STORY_ID}/handoffs/phase-04-deployment-engineer-handoff.manifest.json` exists.
...
Agent(subagent_type="deployment-engineer",
      prompt="Handoff: ${HANDOFF_PATH_DEPLOYMENT_ENGINEER}
              ...
              Deploy ${STORY_ID} to STAGING environment.
