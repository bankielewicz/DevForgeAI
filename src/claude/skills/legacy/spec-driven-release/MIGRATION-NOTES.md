# Migration Notes: spec-driven-release -> spec-driven-release

**Migration Date:** 2026-03-18
**Source Skill:** `.claude/skills/spec-driven-release/` (754 lines, 13 phases)
**Target Skill:** `.claude/skills/spec-driven-release/` (8 phases, Execute-Verify-Gate)
**Precedent:** ADR-039 (spec-driven-dev -> spec-driven-dev migration)

---

## Why This Migration

The `spec-driven-release` skill suffered from **token optimization bias** - Claude would skip phases/steps during execution because the skill lacked structural anti-skip enforcement. This created rework for the user and undermined framework integrity.
...
**Zero cross-references** to `.claude/skills/spec-driven-release/`.
...
After validation:
1. Rename `spec-driven-release/` to `_spec-driven-release.archive/`
