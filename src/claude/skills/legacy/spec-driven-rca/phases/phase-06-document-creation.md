...
```bash
devforgeai-validate phase-record ${SESSION_ID} --workflow=${WORKFLOW} --phase=06 --step=06.1
```
...
```bash
devforgeai-validate phase-record ${SESSION_ID} --workflow=${WORKFLOW} --phase=06 --step=06.2
```
...
```bash
devforgeai-validate phase-record ${SESSION_ID} --workflow=${WORKFLOW} --phase=06 --step=06.3
```
...
```bash
devforgeai-validate phase-record ${SESSION_ID} --workflow=${WORKFLOW} --phase=06 --step=06.4
```
...
```bash
devforgeai-validate phase-record ${SESSION_ID} --workflow=${WORKFLOW} --phase=06 --step=06.5
```
...
```bash
devforgeai-validate phase-record ${SESSION_ID} --workflow=${WORKFLOW} --phase=06 --step=06.6
```
...
```bash
devforgeai-validate phase-record ${SESSION_ID} --workflow=${WORKFLOW} --phase=06 --step=06.7
```
...
```bash
devforgeai-validate phase-record ${SESSION_ID} --workflow=${WORKFLOW} --phase=06 --step=06.8
```
...
```bash
devforgeai-validate phase-record ${SESSION_ID} --workflow=${WORKFLOW} --phase=06 --step=06.9
```
...
```bash
devforgeai-validate phase-record ${SESSION_ID} --workflow=${WORKFLOW} --phase=06 --step=06.10
```
...
```bash
devforgeai-validate phase-record ${SESSION_ID} --workflow=${WORKFLOW} --phase=06 --step=06.11
```
