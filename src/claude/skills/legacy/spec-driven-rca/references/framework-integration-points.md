...
**Target Audience:** spec-driven-rca skill (Claude executing RCA Phases 1-4)
...
2. **source-tree/** - Project structure rules
...
Root Cause: source-tree/ rules not validated
Evidence Location: source-tree/ + file system + validation code
```
...
- Validated by: spec-driven-system-architecture skill
...
4. `.claude/skills/spec-driven-lifecycle/SKILL.md` - State management
...
4. spec-driven-lifecycle SKILL.md
```
...
/orchestrate → spec-driven-lifecycle
/create-story → spec-driven-stories
/create-design → spec-driven-design
/create-system-architecture → spec-driven-system-architecture
/ideate → spec-driven-ideation
/create-solution-architecture → spec-driven-solution-architecture
/create-sprint → spec-driven-lifecycle (sprint mode)
```
...
spec-driven-ideation:
  Auto-transitions: spec-driven-system-architecture (if context files missing)
...
- `devforgeai/specs/context/` - Context file details
