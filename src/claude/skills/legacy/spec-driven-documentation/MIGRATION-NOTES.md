...
## 2026-03-18: Absorbed spec-driven-documentation (v1.1.0)

### Source Skill
- **Name:** spec-driven-documentation
- **Location:** `src/claude/skills/spec-driven-documentation/`
...
| Aspect | Before | After |
|--------|--------|-------|
| **Skill name** | spec-driven-documentation | spec-driven-documentation |
...
4. **Model Upgraded:**
   - From `claude-sonnet-4-6` to `opus` (consistent with all spec-driven migrations)
...
- Original skill archived to `src/claude/skills/backup/_spec-driven-documentation.archive/`
