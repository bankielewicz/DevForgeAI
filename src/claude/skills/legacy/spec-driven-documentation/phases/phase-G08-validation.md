...
IF coverage < 80:
    ...
    IF user chooses "Add missing documentation":
        ...
        FOR each undocumented_api:
            ...
            : > tmp/${SESSION_ID}/doc-g08-documentation-writer-handoff-changed-files.txt
            ...
            HANDOFF_OUTPUT_DOCUMENTATION_WRITER=$(devforgeai-validate build-subagent-handoff ${SESSION_ID} \
              ...
              --changed-files-file=tmp/${SESSION_ID}/doc-g08-documentation-writer-handoff-changed-files.txt \
              --project-root=. 2>&1)
            ...
            Task(
                ...
                prompt="Handoff: ${HANDOFF_PATH_DOCUMENTATION_WRITER}
                ...
                Add documentation for undocumented API: {undocumented_api}.
                Return Markdown content suitable for the existing generated section.
