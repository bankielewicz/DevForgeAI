...
- [Recovery Procedures](#recovery-procedures)
  - [Step 1: Check Directory Permissions](#step-1-check-directory-permissions)
  - [Step 2: Verify File System Paths](#step-2-verify-file-system-paths)
  - [Step 3: Retry with Error Handling](#step-3-retry-with-error-handling)
  - [Step 4: Provide Manual Creation Instructions](#step-4-provide-manual-creation-instructions)
- [Example Scenarios](#example-scenarios)
  - [Scenario 1: Missing Directory](#scenario-1-missing-directory)
  - [Scenario 2: Permission Denied](#scenario-2-permission-denied)
  - [Scenario 3: Disk Full](#scenario-3-disk-full)
...
If persistent failure after retries:
    ...
    3. Save file
    4. Continue to next epic or run /create-system-architecture
    """
```
