...
- [Recovery Procedures](#recovery-procedures)
  - [Step 1: Detect Conflicts](#step-1-detect-conflicts)
  - [Step 2: Use AskUserQuestion to Resolve Each Conflict](#step-2-use-askuserquestion-to-resolve-each-conflict)
  - [Step 3: Document Resolution in ADR Requirements](#step-3-document-resolution-in-adr-requirements)
  - [Step 4: Update Requirements Spec with Resolved Conflicts](#step-4-update-requirements-spec-with-resolved-conflicts)
- [Example Scenarios](#example-scenarios)
  - [Scenario 1: Technology Stack Conflict](#scenario-1-technology-stack-conflict)
  - [Scenario 2: Architecture Pattern Conflict](#scenario-2-architecture-pattern-conflict)
  - [Scenario 3: Anti-Pattern Violation](#scenario-3-anti-pattern-violation)
...
- ADR creation handled by spec-driven-system-architecture skill (Phase 04)
