...
- [Artifact Creation Checklist](#artifact-creation-checklist)
  - [Epic Documents](#epic-documents)
  - [Requirements Specification](#requirements-specification)
- [Epic Content Quality Checklist](#epic-content-quality-checklist)
  - [YAML Frontmatter (Required Fields)](#yaml-frontmatter-required-fields)
  - [Epic Description & Context](#epic-description-context)
  - [Success Metrics & KPIs](#success-metrics-kpis)
  - [Features Breakdown](#features-breakdown)
  - [Acceptance Criteria](#acceptance-criteria)
  - [Dependencies & Risks](#dependencies-risks)
  - [Timeline & Milestones](#timeline-milestones)
- [Requirements Specification Quality Checklist](#requirements-specification-quality-checklist)
...
- [Complexity Assessment Checklist](#complexity-assessment-checklist)
  - [Complexity Score Calculation](#complexity-score-calculation)
  - [Architecture Tier Recommendation](#architecture-tier-recommendation)
  - [Technology Stack Guidance](#technology-stack-guidance)
  - [Scalability & Performance Targets](#scalability-performance-targets)
- [Handoff Readiness Checklist](#handoff-readiness-checklist)
  - [Artifact Completeness](#artifact-completeness)
  - [Ambiguity Resolution](#ambiguity-resolution)
  - [Risk & Constraint Documentation](#risk-constraint-documentation)
  - [Quality Validation](#quality-validation)
  - [Next Phase Preparation](#next-phase-preparation)
- [User Communication Checklist](#user-communication-checklist)
  - [Completion Summary Presented](#completion-summary-presented)
  - [Next Steps Communicated](#next-steps-communicated)
  - [User Confirmation Requested](#user-confirmation-requested)
- [Self-Healing Validation](#self-healing-validation)
  - [Epic Generation Failures](#epic-generation-failures)
  - [Requirements Spec Completeness](#requirements-spec-completeness)
  - [Complexity Assessment Errors](#complexity-assessment-errors)
...
- [ ] Next phase identified:
  - If no context: Transition to architecture skill (/create-system-architecture)
...
- [ ] User informed of what /create-system-architecture does (6 context files)
- [ ] User informed of expected interaction (AskUserQuestion for technology choices)
- [ ] User informed of transition options:
  - Proceed to /create-system-architecture (greenfield)
...
1. Load this reference: `Read(file_path=".claude/skills/spec-driven-ideation/references/validation-checklists.md")`
