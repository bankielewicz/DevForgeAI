...
This skill was originally created using a shared-reference pattern where phase files loaded references from `spec-driven-brainstorming/references/`. As of 2026-03-18, all reference files, assets, and scripts were migrated into this skill directory to make it fully self-sufficient. The `spec-driven-brainstorming` skill has been archived.
