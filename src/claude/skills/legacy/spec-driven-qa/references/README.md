...
| File | Reason |
|------|--------|
| deep-validation-workflow.md | Consolidated loading enables token optimization bias -- the root cause of phase skipping. Each phase loads only what it needs. Archived with spec-driven-qa. |

## Migration History

- **2026-03-18:** Migrated from `spec-driven-qa` skill. All references, assets, and scripts are now local. `spec-driven-qa` archived to `backup/_spec-driven-qa.archive/`.
