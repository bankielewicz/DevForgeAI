...
**Migration Note:** Absorbed from `spec-driven-feedback` per ADR-040. All references previously loaded from `.claude/skills/spec-driven-feedback/references/` are now self-contained within this skill's `references/` directory.
...
Read(file_path=".claude/skills/spec-driven-feedback/references/context-extraction.md")
```
