...
```
Bash(command="python src/claude/skills/spec-driven-design/scripts/validate_context.py")
# If fails, try operational path:
# Bash(command="python .claude/skills/spec-driven-design/scripts/validate_context.py")
```
...
**Recovery:**
Review and fix the context files, then run /create-design again."
...
- **source-tree/:** Extract correct output location for UI components
...
ui_constraints = {
  ...
  "output_location": "path from source-tree/",
