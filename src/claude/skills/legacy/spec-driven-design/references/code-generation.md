...
```
Bash(command="python src/claude/skills/spec-driven-design/scripts/ensure_spec_dir.py")
# If fails, try operational path:
# Bash(command="python .claude/skills/spec-driven-design/scripts/ensure_spec_dir.py")
```
...
**Parse `source-tree/governance.json` for correct UI component location:**
```
...
**Determine path:**
- Default: `devforgeai/specs/ui/` (if not specified in source-tree/)
- Follow any project-specific structure defined in source-tree/
