...
title: Spec-Driven UI Skill - User Input Guidance Integration
version: "1.0"
created: 2025-01-21
updated: 2025-01-21
status: Published
...
skill: spec-driven-design
---

# Spec-Driven UI Skill - User Input Guidance Integration Reference

**Purpose:** Document how spec-driven-design skill integrates user-input-guidance.md with conditional loading logic for standalone vs story-driven UI generation.
...
**Story Mode:** User runs `/create-design STORY-042` with story file context
...
def phase_2_story_analysis():
    ...
    if is_story_mode:
        ...
        guidance_content = Read(file_path=".claude/skills/spec-driven-design/references/user-input-guidance.md")
...
1. `/create-design "Component description"` (no story file)
2. User runs `/create-design` with text description (not story ID)
3. No story file loaded in conversation

**Skip guidance in these scenarios:**
1. `/create-design STORY-042` (story file provided)
...
- If standalone mode:
  - Execute: `Read(file_path=".claude/skills/spec-driven-design/references/user-input-guidance.md")`
  - If fails, try: `Read(file_path=".claude/skills/spec-driven-design/references/user-input-guidance.md")`
...
**Spec-Driven-UI Deployment:**
- Location: `src/claude/skills/spec-driven-design/references/user-input-guidance.md`
- Deployment: Copy from master using:
  ```bash
  cp src/claude/skills/spec-driven-ideation/references/user-input-guidance.md \
     src/claude/skills/spec-driven-design/references/user-input-guidance.md
  ```

**Operational Folder:**
- Also copied to: `.claude/skills/spec-driven-design/references/user-input-guidance.md`

### 5.2 Checksum Validation

**Verify deployment integrity:**
```bash
# All deployments should have identical SHA256
sha256sum src/claude/skills/spec-driven-design/references/user-input-guidance.md \
          .claude/skills/spec-driven-design/references/user-input-guidance.md
...
def test_ui_standalone_full_flow():
    ...
    # Setup: No story file, user runs `/create-design "Login form"`
...
def test_ui_story_mode_no_guidance():
    ...
    # Setup: Story file loaded, user runs `/create-design STORY-042`
    # Execute: Phase 2 complete
...
**Single spec-driven-design execution:**
...
- [ ] **Spec-Driven-UI Copy:** user-input-guidance.md copied to spec-driven-design/references/
- [ ] **Operational:** user-input-guidance.md synced to .claude/skills/spec-driven-design/
- [ ] **Checksums:** All copies have identical SHA256 hashes
...
- [ ] **Total:** 23 spec-driven-design-specific tests (3 + 3 + 2 new + 15 existing)
