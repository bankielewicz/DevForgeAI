...
When `/create-design` command invokes this skill, it provides context in two modes:
...
3. Invokes: `Skill(command="spec-driven-design")`

**Standalone Mode:**
1. States: "Component description: Login form with validation" and "Mode: standalone"
2. Invokes: `Skill(command="spec-driven-design")`
