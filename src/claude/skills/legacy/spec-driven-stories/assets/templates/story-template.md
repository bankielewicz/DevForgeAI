...
sections:
  - name: "Description"
    header_level: 2
    line_range: {start: 385, end: 393}
    status: "Required"
  - name: "Provenance"
    header_level: 2
    line_range: {start: 394, end: 441}
    status: "Required"
    validation:
      min_origin_count: 2
      required_origin_trace: "brainstorm OR epic"
      enforcement: "conditional_halt"
      skip_when: "no_epic_association"
  - name: "Acceptance Criteria"
    header_level: 2
    line_range: {start: 442, end: 562}
    status: "Required"
  - name: "Technical Specification"
    header_level: 2
    line_range: {start: 563, end: 725}
    status: "Required"
  - name: "Implementation Guide"
    header_level: 2
    line_range: {start: 726, end: 789}
    status: "Conditional"
  - name: "Technical Limitations"
    header_level: 2
    line_range: {start: 790, end: 818}
    status: "Required"
  - name: "Non-Functional Requirements (NFRs)"
    header_level: 2
    line_range: {start: 819, end: 923}
    status: "Required"
  - name: "Dependencies"
    header_level: 2
    line_range: {start: 924, end: 967}
    status: "Required"
  - name: "Test Strategy"
    header_level: 2
    line_range: {start: 968, end: 1004}
    status: "Required"
  - name: "Acceptance Criteria Verification Checklist"
    header_level: 2
    line_range: {start: 1005, end: 1047}
    status: "Required"
  - name: "Edge Cases"
    header_level: 2
    status: "Required"
  - name: "Definition of Done"
    header_level: 2
    line_range: {start: 1048, end: 1088}
    status: "Required"
  - name: "Change Log"
    header_level: 2
    line_range: {start: 1089, end: 1096}
    status: "Required"
  - name: "Notes"
    header_level: 2
    line_range: {start: 1097, end: 1125}
    status: "Required"
  - name: "XML Acceptance Criteria Format"
    header_level: 3
    line_range: {start: 448, end: 467}
    status: "Required"
  - name: "Source Files Guidance"
    header_level: 3
    line_range: {start: 537, end: 562}
    status: "Required"
  - name: "Architecture Decisions"
    header_level: 3
    line_range: {start: 733, end: 740}
    status: "Conditional"
  - name: "Cross-Cutting Concerns"
    header_level: 3
    line_range: {start: 741, end: 750}
    status: "Conditional"
  - name: "Implementation Sequence"
    header_level: 3
    line_range: {start: 751, end: 758}
    status: "Conditional"
  - name: "Task Prompt Templates"
    header_level: 3
    line_range: {start: 759, end: 772}
    status: "Conditional"
  - name: "Anti-Patterns"
    header_level: 3
    line_range: {start: 773, end: 779}
    status: "Conditional"
  - name: "Patterns and References"
    header_level: 3
    line_range: {start: 780, end: 789}
    status: "Conditional"
  - name: "Performance"
    header_level: 3
    line_range: {start: 821, end: 837}
    status: "Required"
  - name: "Security"
    header_level: 3
    line_range: {start: 838, end: 866}
    status: "Required"
  - name: "Scalability"
    header_level: 3
    line_range: {start: 867, end: 884}
    status: "Required"
  - name: "Reliability"
    header_level: 3
    line_range: {start: 885, end: 902}
    status: "Required"
  - name: "Observability"
    header_level: 3
    line_range: {start: 903, end: 923}
    status: "Required"
  - name: "Prerequisite Stories"
    header_level: 3
    line_range: {start: 926, end: 937}
    status: "Required"
  - name: "External Dependencies"
    header_level: 3
    line_range: {start: 938, end: 952}
    status: "Required"
  - name: "Technology Dependencies"
    header_level: 3
    line_range: {start: 953, end: 967}
    status: "Required"
  - name: "Unit Tests"
    header_level: 3
    line_range: {start: 970, end: 988}
    status: "Required"
  - name: "Integration Tests"
    header_level: 3
    line_range: {start: 989, end: 998}
    status: "Required"
  - name: "E2E Tests"
    header_level: 3
    line_range: {start: 999, end: 1004}
    status: "Optional"
  - name: "Implementation"
    header_level: 3
    line_range: {start: 1050, end: 1055}
    status: "Required"
  - name: "Quality"
    header_level: 3
    line_range: {start: 1056, end: 1062}
    status: "Required"
  - name: "Testing"
    header_level: 3
    line_range: {start: 1063, end: 1069}
    status: "Required"
  - name: "Documentation"
    header_level: 3
    line_range: {start: 1070, end: 1075}
    status: "Required"
  - name: "TDD Workflow Summary"
    header_level: 3
    line_range: {start: 1077, end: 1081}
    status: "Required"
  - name: "Files Created/Modified"
    header_level: 3
    line_range: {start: 1082, end: 1086}
    status: "Required"
...
# Maintained by: spec-driven-stories skill
#
# Version History:
#
# v3.0 (2026-03-23) - Implementation Guide Enhancement, SECTION_MANIFEST Update (STORY-578, EPIC-089, ADR-047)
#   Changes:
#     - Added <implementation> optional XML element to AC schema in coding-standards.md
#     - Added ## Implementation Guide conditional section (between Technical Specification and Technical Limitations)
#     - Added 6 subsections: Architecture Decisions, Cross-Cutting Concerns, Implementation Sequence, Task Prompt Templates, Anti-Patterns, Patterns and References
#     - Updated SECTION_MANIFEST with Implementation Guide entry (status: Conditional) and 6 subsection entries
#     - Bumped template_version and format_version from 2.9 to 3.0
#   Rationale:
#     - Close the WHAT-WHERE-HOW gap: stories now carry HOW guidance alongside WHAT (AC) and WHERE (Tech Spec)
#     - Enable fresh Claude sessions to implement stories without manual supplemental context
#     - Per-AC implementation element for targeted implementation hints
#     - Story-level Implementation Guide for cross-cutting implementation concerns
#   References:
#     - STORY-578: Template v3.0 Schema and Implementation Guide Section
#     - EPIC-089: Story Template v3.0 Implementation Guide Enhancement
#     - ADR-047: Story Template v3.0 Implementation Guide Enhancement Decision Record
#
# v2.9 (2026-02-09) - Implementation Notes Format Guidance (STORY-403, EPIC-063)
#   Changes:
#     - Added HTML comment block in Definition of Done section area
#     - Comment explains flat structure requirement for DoD items
#     - Comment references extract_section() validator behavior
#     - Comment includes full path to dod-update-workflow.md reference
#     - Bumped template_version and format_version to 2.9
#   Rationale:
#     - Developers don't see critical format requirements at point-of-use
#     - Pre-commit validation fails when DoD items placed under ### subsections
#     - Point-of-use guidance prevents format errors before they occur
#   References:
#     - STORY-403: Document Implementation Notes Format in Story Template
#     - EPIC-063: Phase 09 Framework-Analyst Recommendation Pipeline
#     - dod-update-workflow.md: DoD Update Workflow specification
#
# v2.8 (2026-02-04) - Advisory Story Support (STORY-348, EPIC-054)
#   Changes:
#     - Added advisory field to YAML frontmatter (boolean, optional, default: false)
#     - Added source_gap field for traceability to original gap (pattern: GAP-NNN)
#     - Added source_story field for traceability to story where gap detected (pattern: STORY-NNN)
#     - Advisory field positioned after priority field
#     - Source fields required when advisory: true, omitted for standard stories
#     - Bumped template_version and format_version to 2.8
#   Rationale:
#     - Enable clear identification of advisory (non-blocking) stories
#     - Full traceability from story back to original QA finding
#     - Visual distinction with [ADVISORY] prefix in title
#   References:
#     - STORY-348: Create Advisory Stories with ADVISORY Prefix and Frontmatter
...
#     Location: .claude/skills/spec-driven-stories/scripts/migrate-ac-headers.sh
...
epic: EPIC-XXX
sprint: Backlog
# Sprint field default: "Backlog" for new stories. Only set to a Sprint-NN when /create-sprint assigns the story to a sprint. NEVER reverse-engineer from sibling stories.
status: Backlog
points: [Story points: 1, 2, 3, 5, 8, 13]
depends_on: []
# Array of STORY-NNN IDs this story depends on. Examples: [], ["STORY-044"], ["STORY-044", "STORY-045"]
priority: [High / Medium / Low]
# Advisory story fields (optional - populated by /review-qa-reports for non-blocking gaps)
advisory: false
# Set to true for advisory (non-blocking) stories created from gaps.json with blocking: false
# Advisory stories have [ADVISORY] prefix in title and filename includes 'advisory' slug
source_gap: null
# Gap ID that created this story (e.g., GAP-001). Required when advisory: true. Pattern: GAP-\d{3}
source_story: null
# Story where gap was originally detected (e.g., STORY-123). Required when advisory: true. Pattern: STORY-\d+
# QA-recommendations story fields (optional - populated by /create-story --from-recommendations; template v3.1)
from_recommendations: false
# Set to true when this story was generated from a *-qa-recommendations.md file via /create-story --from-recommendations.
source_recommendations: null
# List of REC-IDs matching REC-STORY-\d+-[CHML]-\d{3}. Required when from_recommendations: true.
cycle_recorded: null
# QA cycle (integer) that surfaced these recs, from qa-recommendations-status.current_cycle. Required when from_recommendations: true.
# DEVARCH pipeline story fields (optional - populated when /create-story ingests a development-architecture story seed; Phase 01 Sub-step 1.2.0)
feature_ref: ""
# F-NN — the feature this story implements, from the Development Architecture Document. Empty for legacy/non-pipeline stories.
source_devarch: ""
# Relative path to the Development Architecture Document (DEVARCH) this story was seeded from. Empty for legacy/non-pipeline stories.
# VCS / PR lifecycle fields (set by /dev preflight, /dev Phase 08, and /qa Phase 06; null until written — ISSUE-724)
branch: null
# Branch name for this story (e.g. story/STORY-NNN). Written by /dev preflight (worktree setup).
pr_base: null
# Target sprint branch for the story PR (e.g. sprint/alpha or main). Written by /dev preflight.
worktree_path: null
# Absolute path of the story worktree (e.g. worktrees/STORY-NNN/). Written by /dev preflight.
pr_number: null
# GitHub PR number. Written by /dev Phase 08 when the story PR is opened.
pr_url: null
# GitHub PR URL. Written by /dev Phase 08 when the story PR is opened.
pr_merged: false
# Set to true by /qa Phase 06 after gh pr merge --squash completes.
merged_sha: null
# Squash-merge commit SHA written by /qa Phase 06 after merge.
merged_at: null
# ISO 8601 timestamp of the squash-merge written by /qa Phase 06.
...
<!-- CONDITIONAL SECTION: Required for feature stories >= 5 points. Optional for all others.
     When not applicable, this entire section is omitted by Phase 05 assembly. Do NOT manually add this section for non-qualifying stories.
     This section bridges WHAT (Acceptance Criteria) and WHERE (Technical Specification) with HOW (implementation approach).
     Added in template v3.0 per ADR-047 and EPIC-089. -->

### Architecture Decisions

<!-- Document key technical decisions that span multiple ACs. Format as table. -->

| Decision | Chosen Approach | Alternatives Considered | Rationale |
|----------|----------------|------------------------|-----------|
| [Decision 1] | [Approach] | [Alt 1, Alt 2] | [Why this approach] |

### Cross-Cutting Concerns

<!-- Document implementation concerns that span multiple ACs but don't belong to any single one. -->

**Error Handling Strategy:**
[Describe error handling approach spanning multiple ACs — e.g., Result pattern, exception hierarchy, retry policies]

**Data Flow:**
[Describe end-to-end data flow across components — e.g., "Request enters via API → validated → processed by service → persisted → event published"]

### Implementation Sequence

<!-- Recommended order of AC implementation based on dependencies between ACs. -->

1. **AC#N** (description) — Foundation; other ACs depend on this
2. **AC#M** (description) — Depends on AC#N
3. **AC#P** (description) — Depends on AC#M

### Task Prompt Templates

<!-- Suggested prompt fragments for subagent invocations. Story author can shape how agents behave. -->

**For test-automator (Phase 02 Red):**
```
[Suggested prompt fragment for test generation — e.g., "Focus on boundary conditions for the validation logic"]
```

**For backend-architect (Phase 03 Green):**
```
[Suggested prompt fragment for implementation — e.g., "Use repository pattern per coding-standards.md, error handling via Result type"]
```

### Anti-Patterns

<!-- What NOT to do, with rationale from planning/exploration. Prevents repeating discovered mistakes. -->

- Do NOT [specific thing] because [reason discovered during planning]
- Do NOT [another thing] because [rationale]

### Patterns and References

<!-- Point to existing code, design patterns, or similar stories as reference. -->

- **Design Pattern:** [Pattern name from coding-standards.md, with section reference]
- **Similar Implementation:** [STORY-NNN that implements a similar feature — use as reference]
- **External Reference:** [Documentation link, if applicable]
