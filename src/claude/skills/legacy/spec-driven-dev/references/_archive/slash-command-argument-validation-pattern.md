...
| Framework | `CLAUDE.md`, `devforgeai/specs/context/anti-patterns.md`, `.claude/skills/` |
...
**Origin:** v1.0 (2025-11-02) from RCA-005 findings. Applied to 5 commands: dev, qa, release, orchestrate, create-design.
