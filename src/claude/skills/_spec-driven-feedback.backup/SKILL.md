...
All references above are located at `.claude/skills/devforgeai-feedback/references/` (shared, not copied).
...
**Hook system reference:** `.claude/skills/devforgeai-feedback/HOOK-SYSTEM.md`
...
FOR phase_num in range(CURRENT_PHASE, 7):  # Phases 01-06
    ...
    3. REFERENCE: Read the phase's reference files as specified in the phase Contract section.
       References are in .claude/skills/devforgeai-feedback/references/ (SHARED, not copied).
...
- **References:** `.claude/skills/devforgeai-feedback/references/` (shared read, not duplicated)
- **Templates:** `.claude/skills/devforgeai-feedback/templates/` (shared read)
- **Hook System:** `.claude/skills/devforgeai-feedback/HOOK-SYSTEM.md` (shared read)
...
- **Original Skill:** `.claude/skills/devforgeai-feedback/SKILL.md` (deprecated — kept as reference host)
