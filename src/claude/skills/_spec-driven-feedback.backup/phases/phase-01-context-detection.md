...
- **STEP COUNT:** 5
- **REFERENCE FILES:**
  - `.claude/skills/devforgeai-feedback/references/context-extraction.md` (~250 lines)
  - `.claude/skills/devforgeai-feedback/references/context-sanitization.md` (~200 lines)
...
Read(file_path=".claude/skills/devforgeai-feedback/references/context-sanitization.md")
```
