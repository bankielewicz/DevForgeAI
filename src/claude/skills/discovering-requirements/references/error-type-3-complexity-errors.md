...
- [Recovery Procedures](#recovery-procedures)
  - [Step 1: Recalculate Using Assessment Matrix](#step-1-recalculate-using-assessment-matrix)
  - [Step 2: Verify All 4 Dimensions Scored](#step-2-verify-all-4-dimensions-scored)
  - [Step 3: Update Requirements Spec with Corrected Assessment](#step-3-update-requirements-spec-with-corrected-assessment)
  - [Step 4: Re-Validate Architecture Tier](#step-4-re-validate-architecture-tier)
- [Example Scenarios](#example-scenarios)
  - [Scenario 1: Score Out of Range](#scenario-1-score-out-of-range)
  - [Scenario 2: Missing Dimension](#scenario-2-missing-dimension)
  - [Scenario 3: Tier Mismatch](#scenario-3-tier-mismatch)
- [Max Recovery Attempts](#max-recovery-attempts)
...
<!-- complexity-assessment-matrix.md reference removed: cross-skill dependency is stale; complexity scoring no longer performed by discovering-requirements (STORY-453, AC3) -->
