...
### 2. Architecture Skill Epic Creation (Ideation Input)

**Trigger:** When architecture skill epic creation receives ideation output
...
### Architecture Skill Epic Creation Integration

Add to architecture skill epic creation Phase 0:
