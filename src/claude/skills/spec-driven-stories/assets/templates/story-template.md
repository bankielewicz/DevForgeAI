...
sections:
  - name: "Description"
    header_level: 2
    line_range: {start: 340, end: 348}
    status: "Required"
  - name: "Provenance"
    header_level: 2
    line_range: {start: 349, end: 396}
    status: "Optional"
  - name: "Acceptance Criteria"
    header_level: 2
    line_range: {start: 397, end: 517}
    status: "Required"
  - name: "Technical Specification"
    header_level: 2
    line_range: {start: 518, end: 679}
    status: "Required"
  - name: "Technical Limitations"
    header_level: 2
    line_range: {start: 681, end: 708}
    status: "Required"
  - name: "Non-Functional Requirements (NFRs)"
    header_level: 2
    line_range: {start: 710, end: 814}
    status: "Required"
  - name: "Dependencies"
    header_level: 2
    line_range: {start: 815, end: 857}
    status: "Required"
  - name: "Test Strategy"
    header_level: 2
    line_range: {start: 859, end: 894}
    status: "Required"
  - name: "Acceptance Criteria Verification Checklist"
    header_level: 2
    line_range: {start: 896, end: 927}
    status: "Required"
  - name: "Definition of Done"
    header_level: 2
    line_range: {start: 939, end: 977}
    status: "Required"
  - name: "Change Log"
    header_level: 2
    line_range: {start: 980, end: 987}
    status: "Required"
  - name: "Notes"
    header_level: 2
    line_range: {start: 988, end: 1017}
    status: "Required"
  - name: "XML Acceptance Criteria Format"
    header_level: 3
    line_range: {start: 403, end: 421}
    status: "Required"
  - name: "Source Files Guidance"
    header_level: 3
    line_range: {start: 492, end: 517}
    status: "Required"
  - name: "Performance"
    header_level: 3
    line_range: {start: 712, end: 728}
    status: "Required"
  - name: "Security"
    header_level: 3
    line_range: {start: 729, end: 757}
    status: "Required"
  - name: "Scalability"
    header_level: 3
    line_range: {start: 758, end: 774}
    status: "Required"
  - name: "Reliability"
    header_level: 3
    line_range: {start: 776, end: 793}
    status: "Required"
  - name: "Observability"
    header_level: 3
    line_range: {start: 794, end: 813}
    status: "Required"
  - name: "Prerequisite Stories"
    header_level: 3
    line_range: {start: 817, end: 828}
    status: "Required"
  - name: "External Dependencies"
    header_level: 3
    line_range: {start: 829, end: 843}
    status: "Required"
  - name: "Technology Dependencies"
    header_level: 3
    line_range: {start: 844, end: 857}
    status: "Required"
  - name: "Unit Tests"
    header_level: 3
    line_range: {start: 861, end: 879}
    status: "Required"
  - name: "Integration Tests"
    header_level: 3
    line_range: {start: 880, end: 889}
    status: "Required"
  - name: "E2E Tests"
    header_level: 3
    line_range: {start: 890, end: 894}
    status: "Optional"
  - name: "Implementation"
    header_level: 3
    line_range: {start: 941, end: 946}
    status: "Required"
  - name: "Quality"
    header_level: 3
    line_range: {start: 947, end: 953}
    status: "Required"
  - name: "Testing"
    header_level: 3
    line_range: {start: 954, end: 961}
    status: "Required"
