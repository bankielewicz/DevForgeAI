...
These are project-policy interfaces, not additional required host metadata. All new JSON schemas are closed Draft 2020-12 records. Read the schema for the selected mode; ordinary authoring requirements and legacy schemas retain their existing meanings.
