...
The Detection Heuristic Engine is invoked during Phase 5.7 of the designing-systems skill workflow. The engine:
...
This 5-step workflow integrates the Detection Heuristic Engine into the designing-systems skill as Phase 5.7. It executes after Phase 5.5 (Prompt Alignment) and before Phase 6 (Epic Creation). The workflow is **non-blocking** — failure does not halt the designing-systems skill.
