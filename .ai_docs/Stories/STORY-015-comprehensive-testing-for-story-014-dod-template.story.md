...
**Given** three updated story files (STORY-027, STORY-028, STORY-029) exist in `.ai_docs/Stories/`
...
def test_full_update_workflow():
    ...
    # Verify files exist
    template = Path(".claude/skills/devforgeai-story-creation/assets/templates/story-template.md")
    story_027 = Path(".ai_docs/Stories/STORY-027-wire-hooks-into-create-story-command.story.md")
    story_028 = Path(".ai_docs/Stories/STORY-028-wire-hooks-into-create-epic-command.story.md")
    story_029 = Path(".ai_docs/Stories/STORY-029-wire-hooks-into-create-sprint-command.story.md")
...
def test_future_story_includes_dod():
    ...
    story_file = Path(".ai_docs/Stories/STORY-TEST-*.story.md")
