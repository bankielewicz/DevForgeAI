...
if context_count == 6:
    ...
    guidance_content = Read(file_path="src/claude/skills/devforgeai-architecture/references/user-input-guidance.md")
else:
...
```python
# Detect story mode
if conversation_contains("@.ai_docs/Stories/STORY-") or context_marker_exists("**Story ID:**"):
    mode = "story"
    skip_guidance = True
    ...
    guidance_content = Read(file_path="src/claude/skills/devforgeai-ui-generator/references/user-input-guidance.md")
```
...
if context_marker_exists("**Command:** create-epic"):
    ...
    guidance_content = Read(file_path="src/claude/skills/devforgeai-orchestration/references/user-input-guidance.md")
