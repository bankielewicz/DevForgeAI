...
- `.devforgeai/research/` (NOT `.ai_docs/research/`)
- `.ai_docs/Stories/` (DevForgeAI standard)
- `.ai_docs/Epics/` (DevForgeAI standard)
...
**And** no outputs written to deprecated locations (`.ai_docs/research/`)
...
**Expected Behavior:** Agent must read `.ai_docs/Epics/{EPIC-ID}.epic.md` to understand context before repository research, ensuring technology recommendations align with epic scope and feature requirements.
