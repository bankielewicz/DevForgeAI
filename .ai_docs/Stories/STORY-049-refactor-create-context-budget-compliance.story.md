...
**Related Documents:**
- Epic: `.ai_docs/Epics/EPIC-007-lean-orchestration-compliance.epic.md`
- Sprint: `.ai_docs/Sprints/Sprint-3.md`
- Parent Story: `.ai_docs/Stories/STORY-030-wire-hooks-into-create-context-command.story.md`
