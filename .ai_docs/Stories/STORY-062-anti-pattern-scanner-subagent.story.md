...
- [ ] YAML frontmatter with `name: anti-pattern-scanner`, `description`, `tools` (Read, Grep, Glob, Bash linters), `model: claude-haiku-4-5-20251001`
...
grep -q "model: claude-haiku-4-5-20251001" src/claude/agents/anti-pattern-scanner.md
