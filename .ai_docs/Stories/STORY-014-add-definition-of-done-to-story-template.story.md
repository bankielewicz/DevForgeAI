...
**Given** STORY-027 file at `.ai_docs/Stories/STORY-027-*.story.md`
...
**Given** STORY-028 file at `.ai_docs/Stories/STORY-028-*.story.md`
**When** the file is edited to add the DoD section
...
**Given** STORY-029 file at `.ai_docs/Stories/STORY-029-*.story.md`
**When** the file is edited to add the DoD section
