...
- `devforgeai/specs/Stories/STORY-078-upgrade-mode-migration-scripts.story.md` - Story file (DoD incomplete)
...
**2. `devforgeai/specs/Stories/STORY-078-upgrade-mode-migration-scripts.story.md` (CRITICAL)**
