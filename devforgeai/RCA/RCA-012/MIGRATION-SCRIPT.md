...
#   migrate-ac-headers.sh devforgeai/specs/Stories/STORY-052-*.story.md
#
# Safety:
...
if [[ -z "$STORY_FILE" ]]; then
  ...
  echo "Example: migrate-ac-headers.sh devforgeai/specs/Stories/STORY-052-user-facing-prompting-guide.story.md"
  echo ""
  exit 1
fi
...
=========================================================================
File: devforgeai/specs/Stories/STORY-052-user-facing-prompting-guide.story.md
...
[2/6] Creating backup...
    Backup created: devforgeai/specs/Stories/STORY-052-user-facing-prompting-guide.story.md.v2.0-backup
...
[6/6] Review and finalization...
  ...
  Next steps:
    1. Review changes:
       diff "devforgeai/specs/Stories/STORY-052-user-facing-prompting-guide.story.md.v2.0-backup" \
            "devforgeai/specs/Stories/STORY-052-user-facing-prompting-guide.story.md"

    2. If changes look correct:
       Keep migrated file (no action needed)
       Optional: rm "devforgeai/specs/Stories/STORY-052-user-facing-prompting-guide.story.md.v2.0-backup"
...
```bash
rm devforgeai/specs/Stories/STORY-052-user-facing-prompting-guide.story.md.v2.0-backup
...
```bash
for story in devforgeai/specs/Stories/STORY-052*.story.md \
             devforgeai/specs/Stories/STORY-053*.story.md \
             devforgeai/specs/Stories/STORY-054*.story.md; do
...
echo "Review changes with: git diff devforgeai/specs/Stories/"
```
...
for backup in devforgeai/specs/Stories/*.v2.0-backup; do
