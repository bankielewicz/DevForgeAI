...
```bash
git reset --hard HEAD
touch devforgeai/specs/Stories/STORY-{300..320}.story.md  # 21 story files
...
**Verify:**
```bash
ls devforgeai/specs/Stories/STORY-3*.story.md  # Should NOT exist
...
```bash
git reset --hard HEAD
touch devforgeai/specs/Stories/STORY-{400..420}.story.md  # 21 stories
