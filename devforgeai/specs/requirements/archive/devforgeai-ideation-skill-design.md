...
- `designing-systems` (define technical constraints)
...
- Architecture decisions with clear requirements (use designing-systems)
...
## Next Steps
1. Invoke designing-systems to create context files
