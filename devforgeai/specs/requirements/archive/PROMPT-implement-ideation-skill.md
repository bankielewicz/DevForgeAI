...
- Reference existing skills for patterns: `.claude/skills/designing-systems/SKILL.md`, `.claude/skills/devforgeai-orchestration/SKILL.md`
...
6. **Integration Points:**
   ...
   - Handoff to: designing-systems (create context files) and devforgeai-orchestration (create sprints/stories)
