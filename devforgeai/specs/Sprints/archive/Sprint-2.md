...
- **Status:** Ready for Dev
- **Description:** Integrate user-input-guidance.md patterns into designing-systems (greenfield context discovery), devforgeai-ui-generator (standalone UI creation), and devforgeai-orchestration (epic creation) skills for consistent user interaction across framework.
