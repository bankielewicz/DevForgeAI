...
1. **Invoke designing-systems:** Create 6 context files
...
**Next Step:** Invoke designing-systems skill to create context files

---

## Phase 1: Architecture (designing-systems)
