...
technical_specification:
  ...
  business_rules:
    ...
    - id: "BR-004"
      ...
      validation: "Check if devforgeai/specs/Stories/STORY-NNN-*.story.md exists"
...
4. **Story file existence:** Before invoking hook, verify `devforgeai/specs/Stories/STORY-NNN-*.story.md` exists on disk. If missing, skip hook (story creation incomplete).
