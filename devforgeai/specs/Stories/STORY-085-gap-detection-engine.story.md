...
**Given** a collection of story files in `devforgeai/specs/Stories/`
...
- The referenced epic ID doesn't exist as a file in `devforgeai/specs/Epics/`
...
3. **Story File Path:** Must exist at `devforgeai/specs/Stories/STORY-{NNN}-*.story.md`.

4. **Epic File Path:** Must exist at `devforgeai/specs/Epics/EPIC-{NNN}-*.epic.md`.
