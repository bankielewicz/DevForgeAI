...
1. Glob all existing stories: devforgeai/specs/Stories/STORY-*.story.md
...
Write to: devforgeai/specs/Stories/{story_id}-{slug}.story.md
...
Expected output:
- Story file created: devforgeai/specs/Stories/STORY-NNN-user-login.story.md
