...
Do not skip any phases nor skip the implementing-stories skill.
...
/qa STORY-001 Deep      # Run QA validation
...
**Invoke implementing-stories skill:**
```
**Story ID:** ${STORY_ID}
...
**Skill executes phases 01-10 sequentially.** See implementing-stories SKILL.md Phase Summary for details.
...
**Reference:** STORY-289, `.claude/memory/Constitution/tech-stack.md` (Technical Debt Threshold Configuration)
