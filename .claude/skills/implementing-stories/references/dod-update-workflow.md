...
**Template File:** See `.claude/skills/implementing-stories/assets/templates/implementation-notes-template.md` for the minimal Implementation Notes template format (≤25 lines).
...
│          ↓                                │
│  Step 5: Populate TDD Tables [MANDATORY]  │
└──────────────────────────────────────────┘
       ↓
   Format validated?
       ↓ YES
...
**Loaded by:** implementing-stories skill after Phase 06 completes
**Cross-referenced by:**
