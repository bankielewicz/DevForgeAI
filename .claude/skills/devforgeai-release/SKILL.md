...
- `.ai_docs/Stories/{story-id}.story.md` (status = Released)
...
```
✅ CORRECT: Read(file_path=".ai_docs/Stories/{story-id}.story.md")
❌ FORBIDDEN: Bash(command="cat .ai_docs/Stories/{story-id}.story.md")
