...
| REFERENCE | `.claude/skills/brainstorming/references/constraint-discovery-workflow.md` |
...
```
Read(file_path=".claude/skills/brainstorming/references/constraint-discovery-workflow.md")
```
