...
| **REFERENCE** | `.claude/skills/brainstorming/references/prioritization-workflow.md` |
...
```
Read(file_path=".claude/skills/brainstorming/references/prioritization-workflow.md")
```
