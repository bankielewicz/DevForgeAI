...
| **REFERENCE** | `.claude/skills/brainstorming/references/handoff-synthesis-workflow.md` |
...
```
Read(file_path=".claude/skills/brainstorming/references/handoff-synthesis-workflow.md")
Read(file_path=".claude/skills/brainstorming/references/output-templates.md")
```
...
EXECUTE:
  ...
  IF response != "Skip":
    # Load templates
    Read(file_path=".claude/skills/brainstorming/assets/templates/readme-brainstorm-template.md")
    Read(file_path=".claude/skills/brainstorming/assets/templates/claude-md-template.md")
    Read(file_path=".claude/skills/brainstorming/assets/templates/gitignore-template.md")
