...
| REFERENCE | `.claude/skills/brainstorming/references/opportunity-mapping-workflow.md` |
...
```
Read(file_path=".claude/skills/brainstorming/references/opportunity-mapping-workflow.md")
```
