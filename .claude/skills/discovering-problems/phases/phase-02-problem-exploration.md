...
| **REFERENCE** | `.claude/skills/brainstorming/references/problem-exploration-workflow.md` |
...
```
Read(file_path=".claude/skills/brainstorming/references/problem-exploration-workflow.md")
