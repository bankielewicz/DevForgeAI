...
| **REFERENCE** | `.claude/skills/brainstorming/references/hypothesis-formation-workflow.md` |
...
```
Read(file_path=".claude/skills/brainstorming/references/hypothesis-formation-workflow.md")
```
