...
```
Read(file_path=".claude/skills/designing-systems/assets/adr-examples/ADR-EXAMPLE-002-orm-selection.md")
```

For state management decisions:
```
Read(file_path=".claude/skills/designing-systems/assets/adr-examples/ADR-EXAMPLE-003-state-management.md")
```

For architecture pattern decisions:
```
Read(file_path=".claude/skills/designing-systems/assets/adr-examples/ADR-EXAMPLE-004-clean-architecture.md")
```

For deployment strategy decisions:
```
Read(file_path=".claude/skills/designing-systems/assets/adr-examples/ADR-EXAMPLE-005-deployment-strategy.md")
```

For scope change decisions:
```
Read(file_path=".claude/skills/designing-systems/assets/adr-examples/ADR-EXAMPLE-006-scope-descope.md")
```
