...
| Role | Component |
|------|-----------|
| Auto-Updated By | spec-driven-dev skill (Phase 06), spec-driven-qa skill |
| Auto-Analyzed By | technical-debt-analyzer subagent (sprint planning, retrospectives) |
| Referenced By | spec-driven-lifecycle skill, /create-sprint, /review-qa-reports |

---

**Template Version:** 2.0 (STORY-285)
**Template Location:** .claude/skills/spec-driven-lifecycle/assets/templates/technical-debt-register-template.md