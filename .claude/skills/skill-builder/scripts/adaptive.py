...
class Reader:
    ...
    def ref(self, value):
        ...
        need(not runtime.excluded(path) and not str(path).replace('\\', '/').endswith('/.claude/devforgeai/project-binding.json'), 'excluded reference; binding contents must remain operational')
