...
**Workflow Deviation Protocol:** Any phase skip, subagent omission, or out-of-sequence execution requires explicit user consent via AskUserQuestion. 
READ(`references/workflow-deviation-protocol.md`)
