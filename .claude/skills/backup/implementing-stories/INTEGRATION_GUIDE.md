...
This guide explains how the `implementing-stories` skill integrates with your spec-driven development framework.
...
└─────────────────┬───────────────┘
                  ↓
┌─────────────────────────────────┐
│   implementing-stories ✓        │ ← YOU ARE HERE
│   TDD Implementation            │
│   • Validates context           │
│   • Writes tests first          │
│   • Implements features         │
...
1. EPIC: E-Commerce Checkout Flow
   ...
   │   │   └─ implementing-stories (implements with TDD)
...
**1. ✅ implementing-stories (COMPLETED)**
...
**4. discovering-requirements (Medium Priority)**
   - Brainstorming & requirements
   - User story creation
...
The `implementing-stories` skill is designed to:
...
**Ready to use:** Invoke with `/implementing-stories` in Claude Code terminal
