...
**Created by:** designing-systems skill (architect-reviewer subagent)
**Invoked by:** implementing-stories skill when user selects "Scope change" for incomplete DoD item
