...
- `implementing-stories` checks context files before coding
...
"Use designing-systems skill to set up project architecture for a new C# backend with React frontend"
```
...
**implementing-stories** → Enforces constraints during coding
