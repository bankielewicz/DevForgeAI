# Discovering-Requirements Output Templates
...
1. Load this reference file: `Read(file_path=".claude/skills/discovering-requirements/references/output-templates.md")`
