...
description: Implementation guide for integrating user-input-guidance.md into discovering-requirements workflow
section: 5
format_version: "1.0"
---

# User Input Integration Guide for discovering-requirements
...
- [Step 0 Implementation Details](#step-0-implementation-details)
  - [Load Mechanism](#load-mechanism)
  - [Error Handling](#error-handling)
- [Pattern Mapping Table](#pattern-mapping-table)
- [Implementation in SKILL.md](#implementation-in-skillmd)
  - [Phase 1 Pattern Application](#phase-1-pattern-application)
  - [Phase 2 Pattern Application](#phase-2-pattern-application)
- [Edge Case Handling](#edge-case-handling)
  - [Guidance Unavailable (Error-Tolerant Behavior)](#guidance-unavailable-error-tolerant-behavior)
  - [Pattern Selection Rules](#pattern-selection-rules)
- [Quality Metrics](#quality-metrics)
  - [Pattern Adoption Rate](#pattern-adoption-rate)
  - [Subagent Re-Invocation Reduction](#subagent-re-invocation-reduction)
  - [Backward Compatibility](#backward-compatibility)
- [Token Efficiency](#token-efficiency)
  - [Guidance File Size Optimization](#guidance-file-size-optimization)
- [Verification Checklist](#verification-checklist)
- [Integration Workflow Summary](#integration-workflow-summary)
...
<!-- user-input-guidance.md is loaded directly by SKILL.md Step 0.5 (STORY-453) -->
