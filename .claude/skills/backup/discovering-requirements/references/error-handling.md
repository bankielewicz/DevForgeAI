...
Redirect index for error handling in the discovering-requirements skill. Each error type has a dedicated reference file with detection logic, recovery procedures, and examples.
