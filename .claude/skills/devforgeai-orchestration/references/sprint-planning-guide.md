...
- **Story Definition:** `.ai_docs/Stories/{STORY-ID}.story.md` - Individual story format
- **Epic Definition:** `.ai_docs/Epics/{EPIC-ID}.epic.md` - Epic parent format
- **Sprint Definition:** `.ai_docs/Sprints/Sprint-{N}.md` - Generated by sprint planner
