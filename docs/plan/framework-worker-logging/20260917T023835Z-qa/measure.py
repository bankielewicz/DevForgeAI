...
result={'platform':'Windows x64','collection':'complete unfiltered152-case campaign','per_file':counts,
...
with (root/'package-results.json').open('x') as f:json.dump(cases[:152],f,indent=2)
