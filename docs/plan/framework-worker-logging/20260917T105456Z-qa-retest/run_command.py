...
CANDIDATE = Path('C:/Projects/DevForgeAI/devforgeai/experiments/codex-worker-probe-logging-qa-fixes')
...
if args.action == 'independent-build':
    ...
    manifest = Path('C:/Projects/DevForgeAI/docs/plan/framework-worker-logging/20260917T102726Z-dev-qa-fixes/supplemental-harness/Cargo.toml')
...
print((attempt/'stdout.txt').read_text(errors='replace')[-1200:])
