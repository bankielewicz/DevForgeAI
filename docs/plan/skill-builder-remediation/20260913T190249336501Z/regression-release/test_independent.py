...
def check(case, argv, expected_exit, field=None, expected=None, read_root=None, extra=None, env=None):
    ...
    row = {'case': case, 'status': 'PASS' if passed else 'FAIL', 'expected': plan, 'actual_exit': result['exit'], 'observed': observed, 'evidence': 'commands/' + case, 'target_digest': '7715f8b80a9b089a4349f6bbb3b502a52d55a03bb2eb2ec65f861ea4be77ff3a'}
    RESULTS.append(row)
