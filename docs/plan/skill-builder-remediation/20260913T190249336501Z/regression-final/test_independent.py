...
def check(case, argv, expected_exit, field=None, expected=None, read_root=None, extra=None, env=None):
    ...
    row = {'case': case, 'status': 'PASS' if passed else 'FAIL', 'expected': plan, 'actual_exit': result['exit'], 'observed': observed, 'evidence': 'commands/' + case, 'target_digest': 'ecb5f8056f18e1d9889de0c829a7e8e48a6feafe1b8f29bc09718d226eb20099'}
    RESULTS.append(row)
