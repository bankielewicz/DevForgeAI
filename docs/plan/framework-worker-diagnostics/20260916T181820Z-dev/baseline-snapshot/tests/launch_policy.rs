...
const EXPECTED_POLICY_SHA256: &str =
    "1dbc48c4a3627f7c5fc7a996935ec507426e4cd90adac058eb81100ac9b526b5";
...
fn fixed_policy_has_exact_closed_identity_and_argument_vector() {
    ...
    assert_eq!(
        launch_policy::ID,
        "codex-0.154.0-readonly-no-external-tools-v2"
    );
    ...
    assert_eq!(
        ...
        serde_json::json!({
            "schema_version": 1,
            "policy_id": "codex-0.154.0-readonly-no-external-tools-v2",
...
fn policy_binding_rejects_every_caller_controlled_identity_mismatch() {
    ...
    for (adapter, schema, policy_id, policy_sha) in [
        ...
        ("codex-0.154.0-stdio", 3, id, sha.as_str()),
