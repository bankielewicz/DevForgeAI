...
$configPath = 'C:\Projects\DevForgeAI\docs\plan\framework-worker-config-fix\20260916T231141Z\valid-edit\config.toml'
$backupPath = 'C:\Projects\DevForgeAI\docs\plan\framework-worker-config-fix\20260916T231141Z\valid-edit\config.toml.bak'
