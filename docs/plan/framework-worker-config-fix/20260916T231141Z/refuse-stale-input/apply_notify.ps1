...
$configPath = 'C:\Projects\DevForgeAI\docs\plan\framework-worker-config-fix\20260916T231141Z\refuse-stale-input\config.toml'
$backupPath = 'C:\Projects\DevForgeAI\docs\plan\framework-worker-config-fix\20260916T231141Z\refuse-stale-input\config.toml.bak'
