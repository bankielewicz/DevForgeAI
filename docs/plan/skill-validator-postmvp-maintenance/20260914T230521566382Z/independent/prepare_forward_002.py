...
root=origin/'forward-002';root.mkdir()
...
''',encoding='utf-8')
    total_expression='sum(data)' if case=='ledger-c' else '0'
...
try:
    source=Path(args.input); destination=Path(args.output)
