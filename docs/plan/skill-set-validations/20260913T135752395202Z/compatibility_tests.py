...
write(RUN/'schema-comparison.json',{'schema_version':'1','schemas':schemas})
write(RUN/'compatibility-results.json',{'schema_version':'1','cases':results})
