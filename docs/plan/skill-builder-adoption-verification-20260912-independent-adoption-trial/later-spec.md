...
decimal string, line_count as an integer, and total_quantity as the exact fixed-point decimal string sum of quantity without rounding. An empty data section returns
{"total":"0.00","line_count":0,"total_quantity":"0"}. Reject missing/extra cells, malformed headers,
