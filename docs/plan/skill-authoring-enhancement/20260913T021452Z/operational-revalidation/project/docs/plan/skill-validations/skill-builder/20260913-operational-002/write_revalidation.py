...
assert set(changed)=={'scripts/authoring.py','scripts/custody.py','references/conversion-rules.md','package-manifest.json','schemas/authoring-contract.schema.json'}
