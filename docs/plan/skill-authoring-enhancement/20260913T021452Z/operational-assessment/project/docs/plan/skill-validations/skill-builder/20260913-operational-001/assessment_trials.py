...
sources = [dict(source_id='spec', original_path=str(R.parents[5] / 'enhancement-spec.md'), retrieved_at_utc=stamp(), snapshot_path='inputs/enhancement-spec.md', sha256=ref(R/'inputs/enhancement-spec.md')['sha256'], sections=['2', '3', '4', '5'], freshness='live_verified'), dict(source_id='standard', url='https://agentskills.io/specification', retrieved_at_utc=stamp(), snapshot_path='inputs/official-refresh.json', sha256=ref(R/'inputs/official-refresh.json')['sha256'], sections=['Frontmatter', 'name field', 'compatibility field'], freshness='live_verified')]
