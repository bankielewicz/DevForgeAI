...
class ReducerTests(unittest.TestCase):
    ...
    def test_coverage_exact_floor_and_missing_measurements(self):
        expected = {'file': 'helper.py', 'total_statements': 100, 'minimum_line_percent': 95, 'statement_lines': list(range(1, 101))}
        ...
        value['executed_lines'].append(0)  # Traced module docstring is not an executable statement.
        self.assertEqual(95, r.grade_coverage({'files': {'helper.py': value}}, expected)['line_percent'])
