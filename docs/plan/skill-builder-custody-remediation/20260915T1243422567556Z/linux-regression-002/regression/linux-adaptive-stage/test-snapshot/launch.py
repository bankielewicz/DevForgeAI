...
value={'command':command,'cwd':str(ROOT),'shell':'Python subprocess argument vector','platform':platform.platform(),'filesystem_root':ROOT.anchor,'start':datetime.datetime.now(datetime.timezone.utc).isoformat(),'timeout_seconds':120}
