...
ROOT = Path(os.environ.get('BUILDER_REVIEW_PROJECT', r'C:\Projects\DevForgeAI'))
RUN = Path(os.environ.get('BUILDER_REVIEW_EVIDENCE', str(Path(__file__).resolve().parent)))
