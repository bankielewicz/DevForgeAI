...
def structure(args):
    ...
    if isinstance(metadata, dict):
        ...
        # advisory_checks emits only divergences, and each stays out of the required
        # reduction: a package that is valid Claude Code and merely non-portable must
        # still reduce to PASS.
        for check_id, _, message in advisory_checks(metadata):
