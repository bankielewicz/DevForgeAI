...
The spec-driven-stories skill is a core framework component invoked by multiple skills and commands for user story generation.
...
2. **spec-driven-lifecycle skill** (epic/sprint decomposition)
...
| 5 | 5.0 | Output directory validation against source-tree/ |
...
- Recommend: Run `/create-system-architecture` to enable validation

### Operating Modes

**Greenfield mode:**
- Context files optional (before /create-system-architecture)
...
```
# spec-driven-lifecycle sets context
...
- Phase 2: requirements-analysis.md + acceptance-criteria-core.md + acceptance-criteria-domains.md (+acceptance-criteria-refactor.md when `type: refactor`) (~12K tokens; refactor adds ~0.5K)
...
3. **Invoke: `Skill(command="spec-driven-stories")`**
...
**Skill documentation:**
- `.claude/skills/spec-driven-stories/SKILL.md` - Entry point

**Reference files:**
- 8 phase workflow files (story-discovery.md through completion-report.md)
- Supporting guides (acceptance-criteria-core.md, acceptance-criteria-domains.md, acceptance-criteria-refactor.md, story-examples.md, etc.)
