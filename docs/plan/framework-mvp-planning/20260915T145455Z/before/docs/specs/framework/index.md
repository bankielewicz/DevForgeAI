...
The [configuration structural reference](references/codex-config-schema-20260915.json) accompanies DFF-06. It is upstream schema evidence with limitations, not an installed profile. The [documentation verification record](../../plan/framework-foundation/20260915T111940Z/verification.md) records this baseline's link, consistency and preservation checks; it does not report product TDD or framework acceptance.
