...
def check(case, argv, expected_exit, field=None, expected=None, read_root=None, extra=None, env=None):
    ...
    row = {'case': case, 'status': 'PASS' if passed else 'FAIL', 'expected': plan, 'actual_exit': result['exit'], 'observed': observed, 'evidence': 'commands/' + case, 'target_digest': '338c70995e72637e0ce84991be110d6a371ab6965faf4009d570156ea0e13cf2'}
    RESULTS.append(row)
