...
## 2026-03-18: Absorbed spec-driven-stories (ADR-041)

**What changed:**
- 22 reference files migrated from `spec-driven-stories/references/` to `spec-driven-stories/references/`
...
- `spec-driven-stories` archived as `_spec-driven-stories.archive/`
...
**Pattern:** Identical to ADR-039 (spec-driven-dev -> spec-driven-dev) and ADR-040 (spec-driven-feedback -> spec-driven-feedback)

**ADR:** `devforgeai/specs/adrs/ADR-041-spec-driven-stories-to-spec-driven-stories-migration.md`
