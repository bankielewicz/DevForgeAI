...
This paired-utility artifact is consumed by skill-builder. It is not a DevForge CLI acceptance schema. The validator evaluates and writes this document; it does not apply the changes.
...
Next implementation owner: skill-builder.
Validation owner after authoring: skill-validator.
...
| --- | --- | --- | --- | --- |
| {{n}} | {{CHG-###}} | {{IDs or none}} | skill-builder | {{authored files and change receipt}} |
...
- Validation status: Not performed by skill-builder.
