...
Status: DRAFT MVP contract, revision 2, 2026-09-05 UTC. This defines the provider migration and subsequent authoring assignments. Revision 2 clarifies evaluation isolation, grading, and package derivation after the first native pilots; it does not certify the existing skills. Read it with the [artifact contract](artifact-contract.md) and [execution contract](execution-contract.md).
