...
| On interruption, preserve the phase and evidence; resume by rechecking identities and the assignment | `references/recording-rules.md` "Resolving an upstream reference" and "When no session record exists" | eval 7 |
...
| Consumer coverage: plan; project-expert-creator; evaluate-expert; develop; review; change | `SKILL.md` phase 4 continuation paragraph; description near-miss clause names the same siblings as owners of their own requests |
