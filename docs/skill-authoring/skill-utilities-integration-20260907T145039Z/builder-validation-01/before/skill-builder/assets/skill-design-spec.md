...
Complete after authoring or enhancement. This receipt records source changes and remaining work; it is not a validation result.
...
[Unchanged selected specification or new authorized revision/identity/path/SHA-256, with the prior identity retained.]
...
**Next handoff:**  
[Separate validator receives the new frozen candidate, accepted specification and receipt. Prior observations do not automatically apply to changed bytes. No validation is launched by the builder.]
