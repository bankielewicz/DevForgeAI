...
| | |
|---|---|
| Implements | `docs/specs/spec/SPEC-003.md` (version 3) |
...
| `skills/architecture/provenance.yaml` | `SKL-003`, `implements` SPEC-003 v3, `skill_name: architecture`, `eval_tag: architecture`, `status: draft` |
