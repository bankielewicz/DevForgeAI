...
| | |
|---|---|
| Implements | `docs/specs/spec/SPEC-003.md` (version 4) |
...
| `skills/architecture/provenance.yaml` | `SKL-003`, `implements` SPEC-003 v4, `skill_name: architecture`, `eval_tag: architecture`, `status: draft` |
