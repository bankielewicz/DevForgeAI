...
| | |
|---|---|
| Implements | `docs/specs/spec/SPEC-003.md` (version 2) |
...
| `skills/architecture/provenance.yaml` | `SKL-003`, `implements` SPEC-003 v2, `skill_name: architecture`, `eval_tag: architecture`, `status: draft` |
