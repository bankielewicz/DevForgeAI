...
| | |
|---|---|
| Implements | `docs/specs/spec/SPEC-003.md` (version 5) |
...
| `skills/architecture/provenance.yaml` | `SKL-003`, `implements` SPEC-003 v5, `skill_name: architecture`, `eval_tag: architecture`, `status: draft` |
