...
approved_on: null
upstream:
  - {id: PRD-001, item: FR-013,  relation: refines, version: 7, hash: null}
  - {id: PRD-001, item: FR-003,  relation: refines, version: 7, hash: null, note: "decisions stay the user's; outcome confirmation is not decision acceptance"}
  - {id: PRD-001, item: FR-004,  relation: refines, version: 7, hash: null, note: "handoff from architecture to the epic workflow"}
  - {id: PRD-001, item: FR-006,  relation: refines, version: 7, hash: null, note: "partial: the Architecture Definition half of the initial rollout"}
  - {id: PRD-001, item: FR-007,  relation: refines, version: 7, hash: null, note: "partial: the Architecture Definition half of the initial rollout"}
  - {id: PRD-001, item: FR-008,  relation: refines, version: 7, hash: null, note: "partial: the Architecture Definition half of the initial rollout"}
