...
approved_on: null
upstream:
  - {id: PRD-001, item: FR-005,  relation: refines, version: 8, hash: null}
  - {id: PRD-001, item: FR-003,  relation: refines, version: 8, hash: null, note: "provenance and user decisions, applied to the PRD skill"}
  - {id: PRD-001, item: FR-004,  relation: refines, version: 8, hash: null, note: "handoff from prd to the architecture step (ADR-002)"}
