...
functional_requirements:
  ...
  - id: FR-006
    status: active
    statement: "Workflows shall obtain applicable organizational policy and project knowledge through a defined interface, not from their own instructions, and shall work with framework defaults when no approved policy exists."
    priority: null
    release: current
    notes: "Adaptive foundation (ADR-003 A3, A6)."
  - id: FR-007
    status: active
    statement: "When policy sources overlap or conflict, workflows shall resolve them by the defined precedence and override rules, and shall stop and report invalid, contradictory or disallowed settings instead of guessing."
    priority: null
    release: current
    notes: "Adaptive foundation (ADR-003 A4)."
  - id: FR-008
    status: active
    statement: "Every generated document shall record which policy settings and knowledge sources informed it, or state that framework defaults were used."
    priority: null
    release: current
  ...
  - id: FR-010
    ...
    priority: null
    release: later
    notes: "Expert catalog, creation and maintenance; contract in ADR-003 A7."
  - id: FR-011
    status: active
