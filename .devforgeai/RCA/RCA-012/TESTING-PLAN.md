...
# Get story filename
TEST_STORY=$(ls -t .ai_docs/Stories/*.story.md | head -1)
...
```
Read: .ai_docs/Stories/STORY-052-user-facing-prompting-guide.story.md
...
**Setup:**
```markdown
# Create: .ai_docs/Stories/TEST-INCOMPLETE-TRACEABILITY.story.md
...
**Cleanup:**
```bash
rm .ai_docs/Stories/TEST-INCOMPLETE-TRACEABILITY.story.md
```
...
**Cleanup:**
```bash
rm .ai_docs/Stories/TEST-UNDOCUMENTED-DEFERRALS.story.md
```
...
# Verify timestamp
grep "User Approval:.*UTC" .ai_docs/Stories/STORY-038*.story.md
...
cp .ai_docs/Stories/STORY-052-user-facing-prompting-guide.story.md /tmp/TEST-STORY-052.story.md
