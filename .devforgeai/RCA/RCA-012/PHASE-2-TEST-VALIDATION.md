...
### Test Story Creation
```bash
cat > .ai_docs/Stories/TEST-MISSING-COVERAGE.story.md << 'EOF'
---
...
### Cleanup
```bash
rm .ai_docs/Stories/TEST-MISSING-COVERAGE.story.md
```
...
### Test Story Creation
```bash
cat > .ai_docs/Stories/TEST-UNDOCUMENTED-DEFERRALS.story.md << 'EOF'
---
