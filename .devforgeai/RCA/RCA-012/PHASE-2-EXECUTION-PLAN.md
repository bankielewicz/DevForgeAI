...
cat > .ai_docs/Stories/TEST-MISSING-TRACEABILITY.story.md << 'EOF'
---
...
**Cleanup:**
```bash
rm .ai_docs/Stories/TEST-MISSING-TRACEABILITY.story.md
```
...
```
.ai_docs/Stories/TEST-MISSING-TRACEABILITY.story.md (deleted after test)
.ai_docs/Stories/TEST-UNDOCUMENTED-DEFERRALS.story.md (deleted after test)
```
