...
**Output:** Epic documents in `.ai_docs/Epics/`, requirements specs in `.devforgeai/specs/requirements/`
...
**Output:** Complete story document in `.ai_docs/Stories/{STORY-ID}.story.md` with all sections
