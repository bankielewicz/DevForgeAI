...
> Draft-ready - the persistence expert is written against the specification, and every rule in it traces to an accepted decision rather than a guess.
>
...
> Blocked - nothing was written. The assignment record shows `fixture-other-writer` holds `project/experts/notes-storage/**`, and that is the fence this task needs.
>
...
>
> No file was deleted, reset or written elsewhere. Design status: `COULD_NOT_RUN` for the authoring step, with the collision as the recorded cause.
