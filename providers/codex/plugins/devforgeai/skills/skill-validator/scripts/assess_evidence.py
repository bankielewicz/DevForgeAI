...
def summarize_v2(plan_path, result_path, output_path):
    ...
    if record["ai_review"] is not None:
        try:
            ...
            require(delivery.get("schema_version") == "devforge.utility-delivery/v2" and delivery.get("validation_policy") == {"version": "VPR-2", "policy_ref": p["policy_ref"], "acceptance_ref": p["acceptance_ref"], "plan": plan_ref}, "T04 delivery selection mismatch")
