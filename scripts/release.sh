...
# =============================================================================
# Sync source of truth to operational directories:
# - src/claude/ → .claude/ (framework skills, commands, agents)
# - src/devforgeai/ → devforgeai/ (context files, templates, configs)
